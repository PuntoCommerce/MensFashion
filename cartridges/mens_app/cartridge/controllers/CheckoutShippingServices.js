  ...
  function (req, res, next) {
      ...
      if (Object.keys(shippingFormErrors).length > 0) {
          ...
          result.address = {
              ...
              address1: form.shippingAddress.addressFields.address1.value + ' ' + form.shippingAddress.addressFields.numExt.value + ' ' + form.shippingAddress.addressFields.numInt.value,
              address2: form.shippingAddress.addressFields.address2.value + ' ' + form.shippingAddress.addressFields.reference.value,
