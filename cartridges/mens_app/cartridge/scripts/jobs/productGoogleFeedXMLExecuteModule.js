 ...
 */
function GenerateXMLGoogleMerchant(args) {

  let final = new File(File.CATALOGS + "/" + args.siteNameURL + "/default/" + args.fileName + ".xml");
...
/* Exported functions */
module.exports = {
    GenerateXMLGoogleMerchant: GenerateXMLGoogleMerchant
};
